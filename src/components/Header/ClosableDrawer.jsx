...
const ClosableDrawer = (props) => {
  ...
  const [filters, setFilters] = useState([
    ...
    {func: selectMenu, label: "FEMALE", id: "female", value: "/?gender=female"},
  ]);
    ...
    <nav className={classes.drawer}>
      ...
      >
        <div className={classes.toolbarsearchField}>
          <TextInput fullWidth={false} label={"キーワードを入力"} onChange={inputKeyword} required={false} rows={1} value={keyWord} type={"text"} />
          <IconButton>
            <SearchIcon />
          </IconButton>
        </div>
